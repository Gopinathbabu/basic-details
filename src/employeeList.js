...
const ShowEmployeeList = ({addEmpDetails, deletingEmp, editEmp}) => {
    ...
    if(addEmpDetails) {
        table = addEmpDetails.map((item, i) => (
                    <tr className='employee__container__trow' key={item.id} value={item.id}>
                        ...
                        <td className='employee__container__trow__tdata'>
                            <button className='employee__container__trow__tdata__del-button' value={i} onClick={(value) => deletingEmp(i)}>Delete Employee</button>
                        </td>
                        <td className='employee__container__trow__tdata'>
                            <button className='employee__container__trow__tdata__edit-button' value={item} onClick={(value) => editEmp(i)}>Edit Employee</button>
                        </td>
                    </tr>
                ...
                <table>
                    <tbody>
                        <tr className='employee__container__trow'>
                            <th className='employee__container__trow__thead'>First Name</th>
                            <th className='employee__container__trow__thead'>Last Name</th>
